...
!!! note "On Windows"
    You will be using the [Anaconda Prompt](https://www.anaconda.com/docs/getting-started/miniconda/install/windows-gui-install#verify-your-install) to access your command line terminal. Go to the Windows  "search bar" and type in "Anaconda Promt", then launch the prompt.
